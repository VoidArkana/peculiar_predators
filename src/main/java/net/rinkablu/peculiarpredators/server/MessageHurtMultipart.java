...
import net.rinkablu.peculiarpredators.common.entity.custom.ShastaPartEntity;
                    ...
                    if (player.level() != null) {
                        ...
                        if (dmg != null) {
                            ...
                            if (holder != null) {
                                ...
                                if (part instanceof ShastaPartEntity && parent instanceof LivingEntity) {
                                    ((ShastaPartEntity) part).onAttackedFromServer((LivingEntity) parent, message.damage, source);
                                }
